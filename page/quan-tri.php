      ...
      <div class="row-fluid">
        <div class="span3">
          <div class="sidebar-nav">
            <a href="quan-tri.php?page=home">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#home-menu"><img height="40" width="40" src="../images/home.png" />&nbsp;&nbsp;Trang Chủ</div>
            ...
            <a href="quan-tri.php?page=tkb-sv">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#settings-menu"><img height="40px" width="40px" src="../images/tkb-sv.png" />&nbsp;&nbsp;Thời Khóa Biểu Sinh Viên<span style="float:right"></span></div>
              <ul id="settings-menu" class="nav nav-list collapse in" style="border:none; background-color:rgb(4,84,175);color:#FFF">
              </ul>
            </a>
            <a href="quan-tri.php?page=ds-gv">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#settings-menu1"><img height="40px" width="40px" src="../images/tkb-sv.png" />&nbsp;&nbsp;Danh Sách Giảng Viên<span style="float:right"></span></div>
              <ul id="settings-menu" class="nav nav-list collapse in" style="border:none; background-color:rgb(4,84,175);color:#FFF">
              </ul>
            </a>
            ...
            <a href="quan-tri.php?page=export_ex">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#settings-menu1"><img height="40px" width="40px" src="../images/export-icon.png" />&nbsp;&nbsp;Export File<span style="float:right"></span></div>
              <ul id="settings-menu" class="nav nav-list collapse in" style="border:none; background-color:rgb(4,84,175);color:#FFF">
              </ul>
            </a>
            <a href="quan-tri.php?page=logout">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#back-menu"><img height="40px" width="40px" src="../images/logout.png" />&nbsp;&nbsp;Đăng Xuất</div>
        ...
        if (!$hal) {
          ...
          switch ($hal) {
            ...
            case "ds-gv":
              ...
              break;
            case "tkb-du-kien":
              include "tkb-du-kien.php";
              break;
            case "tt-dk":
              include "tt-dk.php";
              break;
            case "sv-khong-dk":
              include "sv-khong-dk.php";
              break;
            case "ds-lop":
              include "ds-lop.php";
              break;
            case "add-tkb-du-kien":
              include "add-tkb-du-kien.php";
              break;
            case "ed-mon-hoc":
              include "../module/load-view-mon.php";
              break;
            case "tkb-sv":
              include "s-tkb-sv.php";
              break;
            case "logout":
              include "../module/logout.php";
              break;
            case "export_ex":
              include "../module/export.php";
              break;
            default:
              include "page_null.php";
              break;
          }
        }
        ?>
