      ...
      <div class="row-fluid">
        <div class="span3">
          <div class="sidebar-nav">
            <a href="dang-ky-tkb.php?page=home">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#home-menu"><img height="30" width="30" src="../images/user-profile.png" />&nbsp;&nbsp;Trang Chủ</div>
              <ul id="home-menu" class="nav nav-list collapse in" style="border:none; background-color:rgb(4,84,175);color:#FFF">

              </ul>
            </a>
            <a href="dang-ky-tkb.php?page=dang-ky">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><img height="30px" width="30px" src="../images/tick.png" />&nbsp;&nbsp;Đăng Ký Thời Khóa Biểu<span style="float:right"></span></div>
              <ul id="dashboard-menu" class="nav nav-list collapse in" style="border:none; background-color:rgb(4,84,175);color:#FFF">

              </ul>
            </a>
            <a href="dang-ky-tkb.php?page=logout">
              <div style="background-color:#00C; color:#FFF; font-size:16px; font-weight:bold;" class="nav-header" data-toggle="collapse" data-target="#back-menu"><img height="30px" width="30px" src="../images/logout.png" />&nbsp;&nbsp;Đăng Xuất</div>
